...
//         va_start(args, msg);
//         vsnprintf(buf, 1023, msg, args);//Weakness here!
//         va_end(args);
//         buf[1023] = 0;
//         result =
...
libxml_buildMessage(const char *msg, va_list ap)
{
    ...
    chars = vsnprintf(str, 999, msg, ap);//Weakness Here!
    if (chars >= 998)
        str[999] = 0;
...
//         va_start(ap, msg);
//         vfprintf(stderr, msg, ap);//WEakness Here!
//         va_end(ap);
//     } else {
//         va_start(ap, msg);
//         if (vsnprintf(str, 999, msg, ap) >= 998)//WEakness here!
// 	    str[999] = 0;
//         va_end(ap);
